defmodule Matplotex.PieChartTest do
  ...
  setup do
    ...
    {:ok, %{params: params,content_params: content_params, chartset: pie_chart, chartset_with_content: chartset_with_content, chartset_with_elements: chartset_with_element }}
  ...
  describe "set_content/1" do
    test "will return a piechart with content", %{content_params: content_params, chartset: chartset} do
  ...
  describe "generate_svg/1" do
    test "will generate svg by a chartset with valid elements", %{chartset_with_elements: chartset} do
