defmodule Matplotex.PieChartTest do
  ...
  setup do
    ...
    {:ok, %{params: params,content_params: content_params, chartset: pie_chart, chartset_with_content: chartset_with_content }}
  ...
  describe "add_elements/1" do
    test "will return a chartset with elements", %{chartset_with_content: chartset} do
      assert %PieChart{element: %Element{}} = PieChart.add_elements(chartset)
    end
  end
end
